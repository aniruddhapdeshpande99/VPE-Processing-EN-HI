...
from resolution.modals_resolution.nominal_subject_scoring import nsubj_same_sen_scoring, nsubj_prev_sen_scoring
from resolution.modals_resolution.complement_clause_scoring import score_complement_clause_same_sen, score_complement_clause_prev_sen
from resolution.modals_resolution.aux_scoring import aux_scoring_same_sen, aux_scoring_prev_sen
from resolution.modals_resolution.verb_list_cleaners import verb_list_cleaner_same_sen, verb_list_cleaner_prev_sen
...
def resolve_modals(Parsed_vpe_sen, Verb_list_same_sen, all_sen_vpe, vpe_sent_dict, Parsed_prev_sents, Verb_lists_previous_sens, sentence_speakers_list, sen_indices, parsed_conversation, temp_entry_output_storage_file):
