...
from resolution.to_be_resolution.nominal_subject_scoring import nsubj_same_sen_scoring, nsubj_prev_sen_scoring
from resolution.to_be_resolution.complement_clause_scoring import score_complement_clause_same_sen, score_complement_clause_prev_sen
from resolution.to_be_resolution.aux_scoring import aux_scoring_same_sen, aux_scoring_prev_sen
from resolution.to_be_resolution.verb_list_cleaners import verb_list_cleaner_same_sen, verb_list_cleaner_prev_sen
...
def backtracking_score_same_sen(vpe_sent_dict, Verb_list_same_sentence):
    ...
    # Step 16.2.1: Loop WHILE POS Tag of the 'parent' variable is NEITHER a Gerund/Present Participle NOR Verb Past Participle
    # AND WHILE Dependency relation of 'parent' is not Root
    # AND WHILE POS Tag of 'parent' is not Adjective
    # DO Change the value of 'parent' to its parent in the dependency relation
    ...
    # Step 16.2.1: After the LOOP check IF the POS Tag of the 'parent' index token 
    # is Gerund/Present Participle OR Verb Past Participle and IF True
    # then Assign 'parent' value to variable 'backtracking_verb'
...
def resolve_to_be(Parsed_vpe_sen, Verb_list_same_sen, all_sen_vpe, vpe_sent_dict, Parsed_prev_sents, Verb_lists_previous_sens, sentence_speakers_list, sen_indices, parsed_conversation, temp_entry_output_storage_file):
